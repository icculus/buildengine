...
static unsigned char hxsiz_val = 26;
static unsigned char hysiz_val = 6;
static unsigned char hmach3_val = 6;
static char *hoffs_val = 0x88888888;
static unsigned long fixchain1_val = 320;
static unsigned long fixchain2_val = 0x88888888;
static char *pal_val = (char *) 0x88888888;
static unsigned long hmach4_val = 0x88888888;
static unsigned long hmach1_val = 0x88888888;

/*
_sethlinesizes (long (eax), long (ebx), long (ecx))
...
long sethlinesizes(long i1, long i2, long i3)
{
    unsigned char al = (i1 & 0xFF);
    unsigned char bl = (i2 & 0xFF);
    unsigned long edx = 0;

    machxbits_val = al;
    al ~= al;
    hxsiz_val = al;
    machinenegxbits_val = al;
...
/*
    Used in Pentium II/Pentium Pro overlay. --ryan.
ALIGN 16
...
/*
_setuphlineasm4_(long (eax), long (ebx))
...
_hlineasm4_ (long (eax), long (ebx), long (ecx), long (edx), long (esi), long (edi))
	push ebp
...
long hlineasm4(unsigned long eax, unsigned long ebx, unsigned long ecx,
...
printf("hlineasm4 w00t.\n");
    ...
    if ((edi & 2) == 0)
    {
        ...
        esi -= asm1;
        edx -= asm2;
        *(((char *) edi) - 1) = pal_val[ecx];
        edi -= 2;
        ebp -= 2;
    } // if

    eax = esi >> (32 - machxbits_val);
    esi <<= machxbits_val;
    edx = (edx & 0xFFFFFFF00) | (eax & 0x000000FF);
    edi++;
...
prohbuf:
	...
	ret
*/
long prohlineasm4 (long eax, long ebx, long ecx, long edx, long esi, long edi)
{
	fprintf(stderr, "STUB: prohlineasm4() %s line %d\n",__FILE__,__LINE__);
	return(0);
}
...
setupvlineasm_:
	...
	ret
*/
long setupvlineasm (long eax)
{
	fprintf(stderr, "STUB: setupvlineasm() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
prosetupvlineasm_:
	...
	ret
*/
long prosetupvlineasm (long eax)
{
	fprintf(stderr, "STUB: prosetupvlineasm() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
setupmvlineasm_:
	...
	ret
*/
long setupmvlineasm (long eax)
{
	fprintf(stderr, "STUB: setupmvlineasm() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
setuptvlineasm_:
	...
	ret
*/
long setuptvlineasm (long eax, long ebx, long ecx)
{
	fprintf(stderr, "STUB: setuptvlineasm() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
premach3a: shr edx, 32
	...
	ret
*/
long prevlineasm1 (long eax, long ebx, long ecx, long edx, long esi, long edi)
{
	fprintf(stderr, "STUB: prevlineasm1() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
fixchain1b: add edi, 320
	...
	ret
*/
long vlineasm1 (long eax, long ebx, long ecx, long edx, long esi, long edi)
{
	fprintf(stderr, "STUB: vlineasm1() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
fixchain1m: add edi, 320
	...
	ret
*/
long mvlineasm1 (long eax, long ebx, long ecx, long edx, long esi, long edi)
{
	fprintf(stderr, "STUB: mvlineasm1() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
fixtransluscence_:
	...
	ret
*/
long fixtransluscence (long eax)
{
	fprintf (stderr, "STUB: fixtransluscence() %s line %d\n",__FILE__,__LINE__);
	return (0);
}
...
long settransnormal (void)
{
	fprintf (stderr, "STUB: settransnormal() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
...
long settransreverse (void)
{
	fprintf (stderr, "STUB: settransreverse() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
...
fixchain1t: add edi, 320
	...
	ret
*/
long tvlineasm1 (long eax, long ebx, long ecx, long ecx, long esi, long edi)
{
	fprintf (stderr, "STUB: tvlineasm1() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
...
machvsh8: shl edx, 88h     ;16-sh
	...
	ret
*/
long vlineasm4 (long ecx, long edi)
{
	fprintf (stderr, "STUB: vlineasm4() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
/*
	;eax: -------temp1-------
...
promachvsh8: shl edx, 88h     ;16-sh
	...
	ret
*/
long provlineasm4 (long ecx, long edi)
{
	fprintf (stderr, "STUB: provlineasm4() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
...
setupspritevline_:
	...
	ret
*/
long mvlineasm4 (long ecx, long edi)
{
	fprintf (stderr, "STUB: mvlineasm4() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
/*
ALIGN 16
...
endsvline:
	ret
*/
long spritevline (long eax, long ebx, long ecx, long edx, long esi, long edi)
{
	fprintf (stderr, "STUB: spritevline() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
...
msetupspritevline_:
	...
	ret
*/
long msetupspritevline (long eax, long ebx, long ecx, long edx, long esi, long edi)
{
	fprintf (stderr, "STUB: msetupspritevline() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
/*
ALIGN 16
...
mendsvline:
	ret
*/
long mspritevline (long eax, long ebx, long ecx, long edx, long esi, long edi)
{
	fprintf (stderr, "STUB: mspritevline() %s line %d\n", __FILE__,__LINE__);
	return (0);
}
...
setupqrhlineasm4_:
	...
	;Non power of 2, non masking, with palookup method (FASTER BUT NO SBBS)
	;eax: dat dat dat dat
	;ebx:          bufplc
	;ecx:  0          dat
	;edx:  0          dat
