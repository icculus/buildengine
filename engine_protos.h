...
extern void drawpixel(long offset, Uint8 pixel);
extern void drawpixels(long offset, Uint16 pixels);
extern void drawpixelses(long offset, Uint32 pixelses);
...
extern Uint32 _timer_catcher(Uint32 interval, void *bleh);
